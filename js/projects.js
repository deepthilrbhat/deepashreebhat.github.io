...
import { URLs } from '/user-data/urls.js';
  ...
  function populateProjects(items, id) {
    ...
    // Add Context
    const contextTitle = document.createElement("h6");
    contextTitle.className = "project-heading";
    contextTitle.textContent = "Context:";
    projectdesign.append(contextTitle);

    const contextElement = document.createElement("p");
    contextElement.className = "project-description";
    contextElement.textContent = items.context;
    projectdesign.append(contextElement);

    // Add Challenges
    const challengesTitle = document.createElement("h6");
    challengesTitle.className = "project-heading";
    challengesTitle.textContent = "Challenges:";
    projectdesign.append(challengesTitle);

    //const challengesList = document.createElement("ul");
    items.challenges.forEach(challenge => {
        const listItem = document.createElement("p");
        listItem.className = "project-description";
        listItem.innerHTML = "&blacksquare; " + challenge;
        //listItem.textContent = challenge;
        //challengesList.appendChild(listItem);
        projectdesign.append(listItem);

    });

     // Add Approach
    const approachTitle = document.createElement("h6");
    approachTitle.className = "project-heading";
    approachTitle.textContent = "Approach:";
    projectdesign.append(approachTitle);

    //const approachList = document.createElement("ul");
    items.approach.forEach(step => {
        const listItem = document.createElement("p");
        listItem.className = "project-description";
        listItem.innerHTML = "&blacksquare; " + step;
    ...
    // Add Impact
    const impactTitle = document.createElement("h6");
    impactTitle.className = "project-heading";
    impactTitle.textContent = "Impact:";
    projectdesign.append(impactTitle);

    //const impactList = document.createElement("ul");
    items.impact.forEach(item => {
        const listItem = document.createElement("p");
        listItem.className = "project-description";
        listItem.innerHTML = "&blacksquare; " + item;
    ...
    // Add My Role
    const myRoleTitle = document.createElement("h6");
    myRoleTitle.className = "project-heading";
    myRoleTitle.textContent = "My Role:";
    projectdesign.append(myRoleTitle);

    const myRoleElement = document.createElement("p");
    myRoleElement.className = "project-description";
    myRoleElement.textContent = items.myrole;
    projectdesign.append(myRoleElement);
    ...
    items.forEach(function (item) {
      if (item.label !== "copyright-text") {
        ...
        item.data.forEach(function (data) {
          ...
          console.log("not adding icon");
          if(data.fontAwesomeIcon){
            console.log("Adding icon:", data.fontAwesomeIcon);
  ...
  populateProjects(project1, "project1");
  populateProjects(project2, "project2");
  populateProjects(project3, "project3");
  populateProjects(project4, "project4");
